...
const envSchema = z.object({
  ...
  STRAVA_CLIENT_SECRET: z.string().min(1, "STRAVA_CLIENT_SECRET is required"), // adjust min
  ...
  SUPABASE_URL: z.string().url("SUPABASE URL INVALID"),
  SUPABASE_KEY: z.string().min(1, "SUPA BASE KEY INVALID"), // adjust min
